        ...
        missions: [
          {
            id: 'man-m1',
            title: 'Treasure Hunt',
            description: 'Navigate through clues scattered across the village (College Campus). Only the sharpest minds will uncover the hidden treasures.',
